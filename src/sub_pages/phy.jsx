...
const AccordionItem = ({ title, content, isOpen, onClick, pdfPath }) => {
  // AccordionItem component remains unchanged
  return (
  ...
  const resources = [
    {
      ...
      pdfPath: "pdf_resources/physics/Units& measurements311305.pdf"
    },
    {
      title: "Electricity , Magnetism and Semiconductors",
      pdfPath: "pdf_resources/physics/UnitIIIThermometry&Fiberoptics.pdf"
    },
    {
      title: "Thermometry and Fibre Optics",
      pdfPath: "pdf_resources/physics/UnitIIIThermometry&Fiberoptics.pdf"
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className={`mb-12 transition-all duration-500 transform
          ...
          <h1 className="text-4xl font-bold text-[#6f2cf5] mb-2">
            Basic Physics <span className="inline-flex items-center">Resources
              <DotLottieReact
                src="https://lottie.host/0502e98c-3f84-4c40-b51b-2fc1a537d2ae/Q48HsMCyEj.lottie"
                loop
                autoplay
                height={200}
                width={200}
          ...
          <p className="text-lg text-gray-600">
            Explore fundamental physics concepts and theories
          </p>
        </div>
